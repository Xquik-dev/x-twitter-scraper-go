...
type SearchTweet struct {
	...
	ContentDisclosure SearchTweetContentDisclosure `json:"contentDisclosure"`
	...
	Media []SearchTweetMedia `json:"media"`
	...
	QuotedTweet SearchTweetQuotedTweet `json:"quoted_tweet"`
	// Quoted or retweeted tweet context. Every object includes id, text, and
	// engagement metrics. A zero metric can mean X did not report the count. Author,
	// media, and conversation fields appear when available.
	RetweetedTweet SearchTweetRetweetedTweet `json:"retweeted_tweet"`
...
// Content disclosure metadata shown by X when a tweet is labeled as paid
// partnership content or AI-generated media.
type SearchTweetContentDisclosure struct {
	Advertising SearchTweetContentDisclosureAdvertising `json:"advertising"`
	AIGenerated SearchTweetContentDisclosureAIGenerated `json:"aiGenerated"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetContentDisclosure) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetContentDisclosure) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetContentDisclosureAdvertising struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetContentDisclosureAdvertising) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetContentDisclosureAdvertising) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetContentDisclosureAIGenerated struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetContentDisclosureAIGenerated) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetContentDisclosureAIGenerated) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Normalized media attached to a tweet.
type SearchTweetMedia struct {
	// Media preview URL
	...
	VideoVariants []SearchTweetMediaVideoVariant `json:"videoVariants"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetMedia) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetMedia) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetMediaVideoVariant struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetMediaVideoVariant) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetMediaVideoVariant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// engagement metrics. A zero metric can mean X did not report the count. Author,
// media, and conversation fields appear when available.
type SearchTweetQuotedTweet struct {
	ID            string `json:"id" api:"required"`
	BookmarkCount int64  `json:"bookmarkCount" api:"required"`
	LikeCount     int64  `json:"likeCount" api:"required"`
	QuoteCount    int64  `json:"quoteCount" api:"required"`
	...
	// Content disclosure metadata shown by X when a tweet is labeled as paid
	// partnership content or AI-generated media.
	ContentDisclosure SearchTweetQuotedTweetContentDisclosure `json:"contentDisclosure"`
	ConversationID    string                                  `json:"conversationId"`
	CreatedAt         string                                  `json:"createdAt"`
	DisplayTextRange  []int64                                 `json:"displayTextRange"`
	Entities          map[string]any                          `json:"entities"`
	...
	IsReply           bool                                    `json:"isReply"`
	Lang              string                                  `json:"lang"`
	Media             []SearchTweetQuotedTweetMedia           `json:"media"`
	Source            string                                  `json:"source"`
	Type              string                                  `json:"type"`
	URL               string                                  `json:"url"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweet) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweet) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Content disclosure metadata shown by X when a tweet is labeled as paid
// partnership content or AI-generated media.
type SearchTweetQuotedTweetContentDisclosure struct {
	Advertising SearchTweetQuotedTweetContentDisclosureAdvertising `json:"advertising"`
	AIGenerated SearchTweetQuotedTweetContentDisclosureAIGenerated `json:"aiGenerated"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Advertising respjson.Field
		AIGenerated respjson.Field
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweetContentDisclosure) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweetContentDisclosure) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetQuotedTweetContentDisclosureAdvertising struct {
	// True when X labels the tweet as paid promotion content.
	IsPaidPromotion bool `json:"isPaidPromotion"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweetContentDisclosureAdvertising) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweetContentDisclosureAdvertising) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetQuotedTweetContentDisclosureAIGenerated struct {
	// Whether the disclosure can be edited on X.
	CanEdit bool `json:"canEdit"`
	// Source of the AI-generated media disclosure.
	DetectionSource string `json:"detectionSource"`
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweetContentDisclosureAIGenerated) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweetContentDisclosureAIGenerated) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Normalized media attached to a tweet.
type SearchTweetQuotedTweetMedia struct {
	// Media preview URL
	MediaURL string `json:"mediaUrl" api:"required"`
	// Any of "photo", "video", "animated_gif".
	Type string `json:"type" api:"required"`
	...
	URL string `json:"url" api:"required"`
	// Available video encodings, ordered as returned
	VideoVariants []SearchTweetQuotedTweetMediaVideoVariant `json:"videoVariants"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		MediaURL      respjson.Field
		Type          respjson.Field
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweetMedia) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweetMedia) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetQuotedTweetMediaVideoVariant struct {
	ContentType string `json:"contentType" api:"required"`
	URL         string `json:"url" api:"required"`
	Bitrate     int64  `json:"bitrate"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
// Returns the unmodified JSON received from the API
func (r SearchTweetQuotedTweetMediaVideoVariant) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetQuotedTweetMediaVideoVariant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// engagement metrics. A zero metric can mean X did not report the count. Author,
// media, and conversation fields appear when available.
type SearchTweetRetweetedTweet struct {
	ID            string `json:"id" api:"required"`
	BookmarkCount int64  `json:"bookmarkCount" api:"required"`
	LikeCount     int64  `json:"likeCount" api:"required"`
	QuoteCount    int64  `json:"quoteCount" api:"required"`
	...
	// Content disclosure metadata shown by X when a tweet is labeled as paid
	// partnership content or AI-generated media.
	ContentDisclosure SearchTweetRetweetedTweetContentDisclosure `json:"contentDisclosure"`
	ConversationID    string                                     `json:"conversationId"`
	CreatedAt         string                                     `json:"createdAt"`
	DisplayTextRange  []int64                                    `json:"displayTextRange"`
	Entities          map[string]any                             `json:"entities"`
	...
	IsReply           bool                                       `json:"isReply"`
	Lang              string                                     `json:"lang"`
	Media             []SearchTweetRetweetedTweetMedia           `json:"media"`
	Source            string                                     `json:"source"`
	Type              string                                     `json:"type"`
	URL               string                                     `json:"url"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweet) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweet) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Content disclosure metadata shown by X when a tweet is labeled as paid
// partnership content or AI-generated media.
type SearchTweetRetweetedTweetContentDisclosure struct {
	Advertising SearchTweetRetweetedTweetContentDisclosureAdvertising `json:"advertising"`
	AIGenerated SearchTweetRetweetedTweetContentDisclosureAIGenerated `json:"aiGenerated"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Advertising respjson.Field
		AIGenerated respjson.Field
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweetContentDisclosure) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweetContentDisclosure) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetRetweetedTweetContentDisclosureAdvertising struct {
	// True when X labels the tweet as paid promotion content.
	IsPaidPromotion bool `json:"isPaidPromotion"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweetContentDisclosureAdvertising) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweetContentDisclosureAdvertising) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetRetweetedTweetContentDisclosureAIGenerated struct {
	// Whether the disclosure can be edited on X.
	CanEdit bool `json:"canEdit"`
	// Source of the AI-generated media disclosure.
	DetectionSource string `json:"detectionSource"`
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweetContentDisclosureAIGenerated) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweetContentDisclosureAIGenerated) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Normalized media attached to a tweet.
type SearchTweetRetweetedTweetMedia struct {
	// Media preview URL
	MediaURL string `json:"mediaUrl" api:"required"`
	// Any of "photo", "video", "animated_gif".
	Type string `json:"type" api:"required"`
	...
	URL string `json:"url" api:"required"`
	// Available video encodings, ordered as returned
	VideoVariants []SearchTweetRetweetedTweetMediaVideoVariant `json:"videoVariants"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		MediaURL      respjson.Field
		Type          respjson.Field
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweetMedia) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweetMedia) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SearchTweetRetweetedTweetMediaVideoVariant struct {
	ContentType string `json:"contentType" api:"required"`
	URL         string `json:"url" api:"required"`
	Bitrate     int64  `json:"bitrate"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
// Returns the unmodified JSON received from the API
func (r SearchTweetRetweetedTweetMediaVideoVariant) RawJSON() string { return r.JSON.raw }
func (r *SearchTweetRetweetedTweetMediaVideoVariant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
