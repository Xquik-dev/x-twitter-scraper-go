...
func TestGeneratedModelsPreserveRawJSON(t *testing.T) {
	...
	models := []rawJSONModel{
		...
		(*DrawRunResponse)(nil),
		(*EmbeddedTweet)(nil),
		(*EmbeddedTweetArticle)(nil),
		(*EmbeddedTweetCard)(nil),
		(*EmbeddedTweetCommunityNote)(nil),
		(*EmbeddedTweetEdit)(nil),
		(*EmbeddedTweetNoteTweet)(nil),
		(*EmbeddedTweetNoteTweetRichtextTag)(nil),
		(*EmbeddedTweetPlace)(nil),
		(*EmbeddedTweetPreviousCounts)(nil),
		(*Error)(nil),
		(*Event)(nil),
		(*EventDetail)(nil),
		...
		(*SearchTweet)(nil),
		(*SearchTweetArticle)(nil),
		(*SearchTweetCard)(nil),
		(*SearchTweetCommunityNote)(nil),
		(*SearchTweetEdit)(nil),
		(*SearchTweetNoteTweet)(nil),
		(*SearchTweetNoteTweetRichtextTag)(nil),
		(*SearchTweetPlace)(nil),
		(*SearchTweetPreviousCounts)(nil),
		...
		(*TweetAuthor)(nil),
		(*TweetDetail)(nil),
		(*TweetDetailArticle)(nil),
		(*TweetDetailCard)(nil),
		(*TweetDetailCommunityNote)(nil),
		(*TweetDetailEdit)(nil),
		(*TweetDetailNoteTweet)(nil),
		(*TweetDetailNoteTweetRichtextTag)(nil),
		(*TweetDetailPlace)(nil),
		(*TweetDetailPreviousCounts)(nil),
		(*TweetMedia)(nil),
		(*TweetMediaFaceRect)(nil),
		(*TweetMediaFocusRect)(nil),
		(*TweetMediaSize)(nil),
		(*TweetMediaVideoVariant)(nil),
		(*UserProfile)(nil),
		(*UserProfileAffiliatesHighlightedLabel)(nil),
		(*UserProfileHighlightsInfo)(nil),
		(*UserProfileIdentityVerification)(nil),
		(*Webhook)(nil),
		...
		(*XAccountNewResponseSanitizedXAccount)(nil),
		(*XAccountNewResponseUnion)(nil),
		(*XAccountNewResponseXAccountConnectionAttemptPending)(nil),
		(*XAccountNewResponseXAccountConnectionChallenge)(nil),
		(*XAccountConnectionAttemptGetResponseUnion)(nil),
		(*XAccountConnectionAttemptGetResponseFailed)(nil),
		(*XAccountConnectionAttemptGetResponsePending)(nil),
		(*XAccountConnectionAttemptGetResponseRequiresEmailCode)(nil),
		(*XAccountConnectionAttemptGetResponseSuccess)(nil),
		...
		(*XTweetGetRepliesResponse)(nil),
		(*XTweetGetRepliesResponseDiagnostic)(nil),
		(*XTweetGetRepliesResponseDiagnosticRichness)(nil),
		(*XTweetGetRepliesResponseDiagnosticStrategiesAttempted)(nil),
		(*XTweetSearchResponseTweetSearchCoverageResponse)(nil),
		(*XTweetSearchResponseTweetSearchCoverageResponseDiagnostic)(nil),
		(*XTweetSearchResponseTweetSearchCoverageResponseDiagnosticStrategy)(nil),
		(*XTweetSearchResponseTweetSearchCoverageResponseDiagnosticStrategyWindow)(nil),
		(*XTweetSearchResponseUnion)(nil),
		...
		(*XUserGetFollowersResponseUnion)(nil),
		(*XUserGetFollowersResponseUserListCoverageResponse)(nil),
		(*XUserGetFollowersResponseUserListCoverageResponseDiagnostic)(nil),
		(*XUserGetFollowersResponseUserListCoverageResponseDiagnosticStrategy)(nil),
		(*XUserGetFollowingResponseUnion)(nil),
		(*XUserGetFollowingResponseUserListCoverageResponse)(nil),
		(*XUserGetFollowingResponseUserListCoverageResponseDiagnostic)(nil),
		(*XUserGetFollowingResponseUserListCoverageResponseDiagnosticStrategy)(nil),
		(*XUserGetVerifiedFollowersResponseUnion)(nil),
		(*XUserGetVerifiedFollowersResponseUserListCoverageResponse)(nil),
		(*XUserGetVerifiedFollowersResponseUserListCoverageResponseDiagnostic)(nil),
		(*XUserGetVerifiedFollowersResponseUserListCoverageResponseDiagnosticStrategy)(nil),
